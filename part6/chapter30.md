...
市场营销可以这么定义：理解客户的痛点（战略营销）和市场上提供的解决方案（竞争分析），创建一个更有效地解决客户问题的方案（产品管理），并让客户了解你的解决方案（战术营销）。
...
选择目标突击点的最佳方法是按照Bill Aulet的书《自律型创业》<sup>②</sup> 中提到的步骤进行。细节方面我不再赘述，感兴趣的朋友可参阅这本书。
